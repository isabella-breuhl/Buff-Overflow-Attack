/**
 * This program takes a hostname and port as command-line arguments, connects using TCP/IPv4
 * to the given port on the given hostname, and writes data that causes the remote program to crash.
 *
...
int main(int argc, char* argv[]) {
	...
	const char *s = "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa\n";
